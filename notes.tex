...
\newenvironment{argument}
  ...
  {\begin{tabular}{@{}>{$}c<{$}@{\enspace}>{$}l<{$}@{}}\arrayrulecolor{black!50}}
  {\end{tabular}}
...
\begin{table}
    ...
    \begin{subtable}[f]{0.5\textwidth}
    %\centering
    \adjustbox{width=\textwidth}{
    \begin{tabular}[f]{ *{2}{cc} }
        \toprule
        %Inference Rule & Argument Form \\
        Inference Rule & Argument Form & Alternate Form \\
        \midrule
        %Modus Ponens & \multicolumn{2}{r}{asdf}asdf \\
        Modus Ponens    &
                        \begin{argument}
                            \premise{p \to q}
                            \premise{p}
    ...
    \end{subtable}
    \label{tab:tbl-inference-rules-1}
    \begin{subtable}[f]{0.5\textwidth}
    %\centering
    \adjustbox{width=\textwidth}{
    %\begin{tabular}{ L{2cm} c c }
    \begin{tabular}[f]{ c c c }
        \toprule
        Inference Rule  & Argument Form & Alternate Form \\
        \midrule
        Elimination     & 
    ...
    \end{subtable}
    \label{tab:tbl-inference-rules-2}
\end{table}
%\end{minipage}
